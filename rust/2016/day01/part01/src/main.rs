...
fn main() {
    ...
    for line in instruction_sets.lines() {
        ...
        for instruction in instructions {
            ...
            match heading {
                Heading::North => coord.1 += instruction.steps as i16,
                Heading::South => coord.1 -= instruction.steps as i16,
                Heading::East => coord.0 += instruction.steps as i16,
                Heading::West => coord.0 -= instruction.steps as i16,
            }
